    ...
    <div>
      ...
      <div className="pt-20">
        <section className="font-[Inter] bg-white text-gray-800">
          ...
          <div className="max-w-6xl mx-auto py-8 text-center container">
          ...
          {/* Section 2: Banner */}
          <div className="relative w-full h-[300px] flex items-center justify-center bg-image">
            <div className="absolute inset-0 bg-black/10"></div>
            <div className="relative text-white text-center">
              <h2 className="text-xl text-white md:text-2xl font-bold mb-2">
                CÁC VỊ TRÍ ĐANG TUYỂN DỤNG
              </h2>
              <p className="text-sm max-w-2xl mx-auto text-white">
